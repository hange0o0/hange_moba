class DebugManager {
    ...
    public testLeaderSkill(begin=21,end=30){
        this.skillResult = {}
        this.skillTestList = []
        this.stop = 0;
        Net.getInstance().outPut = false;
        this.testOneSkill(begin,end);
    }

    private testOneSkill(begin:number,end){
        ...
        if(this.skillTestList.length == 0)
        {
            ...
            //var begin = 21;
            //var end = 30//ObjectUtil.objLength(LeaderSkillVO.data)

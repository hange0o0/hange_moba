    ...
    public constructor() {
        ...
        this.helpObj['day'] = {
            ...
            list:[
                ...
                '研究院中玩家每赢得一场挑战，就会获得[1点]研究分。每当集满10点研究分后，将[永久]得到[1点]战力奖励',
                '研究分永久保留，不会被清零',
                '研究院挑战中使用的是修正场规则（玩家的手牌战力固定为300，与玩家的实际战力无关）'
            ]
        }
        this.helpObj['server'] = {
            title:'天梯竞技场说明',
        ...
        this.helpObj['serverequal'] = {
            ...
            list:[
                '虚空修正场是考量卡士天赋的重要地方',
                '修正场中所有玩家的挑战都不受等级和战力的影响，会在一个相对公平的环境下进行对战（玩家的手牌战力固定为300）',

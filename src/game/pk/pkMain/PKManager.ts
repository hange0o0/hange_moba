class PKManager {
    ...
    public pkWord = {
        win:['求一败','抬走，下一个','来个强点的','对面没人了吗','来让我战个痛快吧','哈哈哈','我的目标是要3胜'],
        win3:['我还想继续呢','就没强一点的吗','我还能再打三个','对面怎么这么弱啊','一打三啊\n真简单啊','本场的MVP我拿定了','3胜！3胜！3胜！'],
        loss:['就差一点','不开心','不高兴','只是运气比我好而已','我就是打酱油的','兄弟们为我报仇啊','赢得太多了\n我来放放水','我们还是有机会的','他其实也快死了',
            ...
            '难受，想哭','哪里跌倒\n哪里爬起'],
        pking:['杀','看招','别跑','来战个痛快','小心你的背后','这招看你怎么躲','我要认真了','再来啊','你就只会这几招吗','我要出大招了','我会赐予你死亡','有破绽'],
        win_view:['太牛B了','好样的','我爱你！','爱死你了','对面太弱了','不错不错','威武','有希望了','好强哦~','想输都难','赢得漂亮','距离胜利又近一步了','看来我不用出手了',
            '加油，再赢一场','队友强\n我躺赢','这就是王者之气啊','刚才你们说什么来着','看到我们队有多强了吧','等会去哪庆功好呢','留几个给我杀啊','放轻点，别把对面吓跑了'],
        loss_view:['你们别高兴得太早','等下我一挑你们仨','这只是让你们的','我们的高手还在后面呢','有输有赢的游戏才好玩','你让得也太明显了吧','我们输得起','这只是练兵而已',
            '我会为你报仇的','王者荣耀，我来守护','有黑幕吧？','怎么会这样。。','输得太难看了','这太欺负人了','你已经尽力了','无眼睇','这样下去我们会输了','你轻敌了','要来个士力架吗'],
        view:['加油','干死他','打啊，别光跑','有破绽','小心后面','哎呀','就差一下了','对，就这样干','看来准备赢了','小心，别大意','oh my ladygaga','你若不举,便是晴天','中午不睡\n下午崩溃',
            '我不下地狱\n谁爱下谁下','漫漫人生路\n总会错几步','行到水穷处，口渴','坐看云起时，头晕','执子之手\n方知子丑','人不犯我\n我不犯人','人若犯我\n斩草除根','水能载舟\n亦能煮粥'
            ,'空口无凭\n吃饭为据','别紧张,我不是好人','光阴似面\n日月如锅','放自己的屁\n让别人闻去','钱不是问题\n问题是没钱','有钱男子汉\n没钱汉子难','走牛B的路\n让傻B去说吧','',
            '只要你敢死\n我就敢埋','要在江湖混\n最好是光棍','一觉醒来\n天都黑了','祖传牛皮癣\n专治老中医','比赛第一\n友谊第二','我一直忙着无聊','听君一席话\n省我十本书','摇啊摇，摇到奈何桥'
            ,'给点阳光\n我就腐烂','心里有座坟\n葬着未亡人','要么忍，\n要么残忍','要么忍，要么残忍','逃课，是一个人的狂欢','上课，是一群人的孤单','出其不\n攻其后背','锻炼肌肉\n防止挨揍','无理取闹\n必有所图',
            '打死你我也不会说','有事勿找\n没事勿扰','好好吃饭\n体重向上','世界那么乱\n装纯给谁看','站的高\n尿的远','名花已有主\n锄头却无情','水浅王八多\n遍地是大哥','逃得了和尚\n逃不了方丈','人不损\n不标准',

class PKManager {
    ...
    public pkWord = {
        ...
        pking:['杀','看招','投降，或者死亡','来战个痛快','小心你的背后','这招看你怎么躲','我要认真了','再来啊','你就只会这几招吗','我要出大招了','我会赐予你死亡','有破绽','你究竟想怎样...',
            '我们来做个了结吧','你的身体有破绽','你空门大开啊','在这边啊','尝尝这个吧','接下...\n这一招吧','用这招....\n来决胜负吧', '马上将你解决掉', '就用你的死来结束吧','别罗嗦了...来吧','来啊!\n互相相害啊','没用的!'],
        ...
        view:['加油','干死他','打啊，别光跑','有破绽','小心后面','哎呀','就差一下了','对，就这样干','看来准备赢了','小心，别大意','oh my\nladygaga','我会让你后悔来到世上','你若不举\n便是晴天','中午不睡\n下午崩溃',
            '我不下地狱\n谁爱下谁下','漫漫人生路\n总会错几步','行到水穷处\n，口渴','坐看云起时\n，头晕','执子之手\n方知子丑','人不犯我\n我不犯人','人若犯我\n斩草除根','水能载舟\n亦能煮粥'
            ,'空口无凭\n吃饭为据','别紧张,我不是好人','光阴似面\n日月如锅','放自己的屁\n让别人闻去','钱不是问题\n问题是没钱','有钱男子汉\n没钱汉子难','走牛B的路\n让傻B去说吧','',
            '只要你敢死\n我就敢埋','要在江湖混\n最好是光棍','一觉醒来\n天都黑了','祖传牛皮癣\n专治老中医','比赛第一\n友谊第二','我一直忙着无聊','听君一席话\n省我十本书','摇啊摇，摇到奈何桥'
            ,'给点阳光\n我就腐烂','心里有座坟\n葬着未亡人','要么忍，\n要么残忍','要么忍，要么残忍','逃课，是一个人的狂欢','上课，是一群人的孤单','出其不意\n攻其后背','锻炼肌肉\n防止挨揍','无理取闹\n必有所图',
            '打死你我也不会说','有事勿找\n没事勿扰','好好吃饭\n体重向上','世界那么乱\n装纯给谁看','站的高\n尿的远','名花已有主\n锄头却无情','水浅王八多\n遍地是大哥','逃得了和尚\n逃不了方丈','人不损\n不标准',

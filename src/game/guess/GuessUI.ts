class GuessUI extends game.BaseWindow {
    ...
    private guess(win){
        ...
        GuessManager.getInstance().guess(type,num,win)
    }
    ...
    private onRChange(){
        ...
        MyTool.changeGray(this.addBtn0,this.cb.selected,true)
        MyTool.changeGray(this.reduceBtn0,this.cb.selected,true)
        MyTool.changeGray(this.h1,!this.cb.selected,true)
        MyTool.changeGray(this.addBtn,!this.cb.selected,true)
        MyTool.changeGray(this.reduceBtn,!this.cb.selected,true)
    ...
    public onShow(){
        ...
        this.h1.value = SharedObjectManager.instance.getMyValue('guess_coin') || this.h1.maximum;

        this.h0.maximum = Math.floor(Math.pow(UM.level,1.5)) * 5
        this.h0.minimum = Math.max(1,Math.floor(this.h0.maximum /100))
        this.h0.value = SharedObjectManager.instance.getMyValue('guess_card') || this.h0.maximum;
